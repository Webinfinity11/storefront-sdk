// Generated from src/schemas/api.ts by scripts/sync-sdk-types.mts.
// Do not edit by hand — run `pnpm sdk:sync-types` instead.
...
export type LocalizedText = { ka?: string; en?: string; ru?: string };
...
export type ApiStore = {
  ...
  payments: { enabled: string[] };
  shipping: {
    flatRate: number;
    freeAbove?: number;
    zones: { id: string; name: string; rate: number; freeAbove?: number }[];
  };
